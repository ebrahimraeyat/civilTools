...
#class StructureModel(QAbstractTableModel):
    ...
    #def data(self, index, role=Qt.DisplayRole):
        ...
        #c_drift = ''
            ...
            #k_drift = self.build.ky_drift
            ...
            #if row == TEXP:
                #return QString.number(Texp, 'f', 3)
            #if row == TEXP125:
                #return QString.number(Texp * 1.25, 'f', 3)
            #if row == TAN:
                #return QString.number(Tan, 'f', 4)
            #if row == K:
                #return QString.number(k, 'f', 3)
            #if row == CFACTOR:
                #try:
                ...
                #except:
                    #pass
            #if row == KDRIFT:
                #return QString.number(k_drift, 'f', 3)
            #if row == CDRIFT:
                #try:
                    #return QString.number(c_drift, 'f', 4)
                #except:
                    #pass
        ##if role == Qt.BackgroundColorRole:
            ##if row == HMAX:
                ##return QVariant(QColor(255, 140, 120))
            ##if row in (K, CFACTOR):
                ##return QVariant(QColor(120, 127, 255))
            ##if row in (KDRIFT, CDRIFT):
                ##return QVariant(QColor(127, 255, 120))
            ##if row == TAN:
                ##if Tan <= 1.25 * Texp:
