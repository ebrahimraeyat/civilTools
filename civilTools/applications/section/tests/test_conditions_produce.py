...
class Test_conditions_produce(unittest.TestCase):
    ...
    def tes_2IPE_flang_plate_web_plate_beam_high_ductility_conditions(self):

        ifCondition, elseCondition, TF = produce_conditions_from_slender_provision({'bf/(2*tf)': '0.3*w',
