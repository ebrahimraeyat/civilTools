...
from applications.records.records.MainWindow import Record
from applications.converter.mainwindow import Converter
...
class FormWidget(QWidget):
    ...
    def form_ui(self):
        ...
        # self.icon_converter = QIcon(":/converter_resources/icons/converter/converter.png")
        ...
        s = "<b>ابزارهای مهندسین عمران</b><br />مجموعه ابزارهای کدباز برای مهندسین عمران تحت لیسانس  GPLv3"
        ...
        self.btn_cfactor = QPushButton(self.icon_cfactor, "ضریب زلزله", self.eng_tab)
        ...
        self.btn_section = QPushButton(self.icon_section, "مشخصات مقاطع", self.eng_tab)
        ...
        self.btn_record = QPushButton("رکورد زلزله", self.eng_tab)
        self.btn_record.setToolTip("کار با رکوردهای زلزله")
        size_policy.setHeightForWidth(self.btn_record.sizePolicy().hasHeightForWidth())
        self.btn_record.setSizePolicy(size_policy)
        self.btn_record.setMinimumSize(self.btn_size)

        # self.btn_converter = QPushButton("Converter", self.eng_tab)
        # self.btn_converter.setToolTip("SI Unit Converter")
        # size_policy.setHeightForWidth(self.btn_converter.sizePolicy().hasHeightForWidth())
        # self.btn_converter.setSizePolicy(size_policy)
        # self.btn_converter.setMinimumSize(self.btn_size)
        # self.btn_converter.setIconSize(self.icon_size)
        ...
        eng_btn_layout.addWidget(self.btn_record, 2, 0)
        # eng_btn_layout.addWidget(self.btn_converter, 3, 0)
        ...
        self.btn_cfactor.clicked.connect(self.btn_cfactor_clicked)
        self.btn_section.clicked.connect(self.btn_section_clicked)
        # self.btn_converter.clicked.connect(self.btn_converter_clicked)
        #self.connect(self.btn_record, SIGNAL("clicked()"), self.btn_record_clicked)
