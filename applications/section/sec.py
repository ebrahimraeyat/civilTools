...
class Unp(Section):
    ...
    def createStandardUnps():
        ...
        UNP6 = Unp("UNP06", 645.8, 30, 60, 9.042, 315700, 45190, 13490, 4514, 6, 6)
        ...
        UNP = {6: UNP6, 8: UNP8, 10: UNP10, 12: UNP12, 14: UNP14, 16: UNP16, 18: UNP18,
...
class Upa(Section):
    ...
    def createStandardUpas():
        ...
        # UPA6 = Upa("UPA06", 751, 36, 65, 12.4, 486000, 87000, 15000, 3680, 7.2, 4.4, )
